...
router.get('/performed-by/:performed_id', getMovementsByPerformedId); // GET /api/inventory-movement/performed-by/:performed_id
router.get('/time/:time', getMovementsByTime); // GET /api/inventory-movement/time/:time
